...
def query_genre():
    ...
    try:
        ...
        query = """SELECT IF(TitleSubtitle IS NOT NULL AND TitleSubtitle != '' AND Author IS NOT NULL AND Author != '', CONCAT('[', TitleSubtitle, ', ', Author, ']'), ISBN) AS Result FROM books WHERE Genre = %s;"""
